...
@EnableJpaRepositories(basePackages = "com.tipsontech.creditcard.repositories.creditcard", entityManagerFactoryRef = "cardEntityManagerFactory", transactionManagerRef = "cardTransactionManager")
@Configuration
